-- Ultras Lions Fleury - import complet MariaDB/MySQL
-- Genere depuis les entites Symfony et les migrations du projet.
-- Attention: ce script supprime les tables existantes avant de les recreer.
...
CREATE TABLE merch_stock (
    ...
    KEY IDX_8FADF0318A86BD8 (merch_id),
    PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE merch_order (
    ...
    KEY IDX_1E733F9EA76ED395 (user_id),
    KEY IDX_1E733F9E67B3B43D (merch_id),
    PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE ticket_order (
    ...
    KEY IDX_E665A4F6A76ED395 (user_id),
    KEY IDX_E665A4F6700047D2 (ticket_id),
    PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE payment_checkout (
    ...
    KEY IDX_73A5E4B6A76ED395 (user_id),
    PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO site_config (site_name, hero_title, hero_subtitle, chants_title, chants_subtitle) VALUES
    ('Ultras Lions Fleury', 'Ultras Lions Fleury', 'Groupe de supporters du FC Fleury 91.', 'Chants', 'Tous nos chants, paroles et audio pour faire vibrer les tribunes.');
...
-- email: ultraslionsfleury@gmail.com
-- mot de passe temporaire: UltrasLions!2026
INSERT INTO users (email, roles, password) VALUES
    ('ultraslionsfleury@gmail.com', JSON_ARRAY('ROLE_ADMIN'), '$2y$10$ObBvuxwt4BN1UyCN65SVw.tzgU0DJq6RNn.wHEe3o8hV1cJpdDaPC');

INSERT INTO doctrine_migration_versions (version, executed_at, execution_time) VALUES
    ('DoctrineMigrations\\Version20250104192616', NOW(), 0),
    ('DoctrineMigrations\\Version20251201212207', NOW(), 0),
    ('DoctrineMigrations\\Version20251202215857', NOW(), 0),
    ('DoctrineMigrations\\Version20251202220409', NOW(), 0),
    ('DoctrineMigrations\\Version20251206013450', NOW(), 0),
    ('DoctrineMigrations\\Version20251215120000', NOW(), 0),
    ('DoctrineMigrations\\Version20251215124500', NOW(), 0),
    ('DoctrineMigrations\\Version20251216120000', NOW(), 0),
    ('DoctrineMigrations\\Version20260213104945', NOW(), 0),
    ('DoctrineMigrations\\Version20260311120000', NOW(), 0),
    ('DoctrineMigrations\\Version20260311123000', NOW(), 0),
    ('DoctrineMigrations\\Version20260316120000', NOW(), 0),
    ('DoctrineMigrations\\Version20260408120000', NOW(), 0),
    ('DoctrineMigrations\\Version20260408123000', NOW(), 0),
    ('DoctrineMigrations\\Version20260411120000', NOW(), 0),
    ('DoctrineMigrations\\Version20260424120000', NOW(), 0),
    ('DoctrineMigrations\\Version20260424123000', NOW(), 0),
    ('DoctrineMigrations\\Version20260424130000', NOW(), 0),
    ('DoctrineMigrations\\Version20260424131000', NOW(), 0);
